...
export type Mutation = {
  ...
  accountConfirmation: Scalars['Boolean'];
...
export type MutationAccountConfirmationArgs = {
  email: Scalars['String'];
};
...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, '_id' | 'createdAt' | 'updatedAt' | 'title' | 'points' | 'textSnippet'>
  & { creator: (
    { __typename?: 'User' }
...
export type RegularUserFragment = (
  { __typename?: 'User' }
  & Pick<User, '_id' | 'username' | 'confirmed'>
);
...
export type AccountConfirmationMutationVariables = Exact<{
  email: Scalars['String'];
}>;
...
export type AccountConfirmationMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'accountConfirmation'>
);
...
export const AccountConfirmationDocument = gql`
    mutation AccountConfirmation($email: String!) {
  accountConfirmation(email: $email)
}
    `;
export type AccountConfirmationMutationFn = Apollo.MutationFunction<AccountConfirmationMutation, AccountConfirmationMutationVariables>;

/**
 * __useAccountConfirmationMutation__
 *
 * To run a mutation, you first call `useAccountConfirmationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAccountConfirmationMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [accountConfirmationMutation, { data, loading, error }] = useAccountConfirmationMutation({
 *   variables: {
 *      email: // value for 'email'
 *   },
 * });
 */
export function useAccountConfirmationMutation(baseOptions?: Apollo.MutationHookOptions<AccountConfirmationMutation, AccountConfirmationMutationVariables>) {
        return Apollo.useMutation<AccountConfirmationMutation, AccountConfirmationMutationVariables>(AccountConfirmationDocument, baseOptions);
      }
export type AccountConfirmationMutationHookResult = ReturnType<typeof useAccountConfirmationMutation>;
export type AccountConfirmationMutationResult = Apollo.MutationResult<AccountConfirmationMutation>;
export type AccountConfirmationMutationOptions = Apollo.BaseMutationOptions<AccountConfirmationMutation, AccountConfirmationMutationVariables>;
...
export const VoteDocument = gql`
    mutation Vote($value: Int!, $postId: ObjectId!) {
...
export const PostVotesDocument = gql`
    query PostVotes($limit: Int!, $cursor: String) {
...
export function usePostVotesQuery(baseOptions: Apollo.QueryHookOptions<PostVotesQuery, PostVotesQueryVariables>) {
        return Apollo.useQuery<PostVotesQuery, PostVotesQueryVariables>(PostVotesDocument, baseOptions);
      }
export function usePostVotesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PostVotesQuery, PostVotesQueryVariables>) {
          return Apollo.useLazyQuery<PostVotesQuery, PostVotesQueryVariables>(PostVotesDocument, baseOptions);
        }
